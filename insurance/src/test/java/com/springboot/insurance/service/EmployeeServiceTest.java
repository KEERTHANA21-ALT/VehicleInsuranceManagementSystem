...
public class EmployeeServiceTest {
    ...
    public void addTest() {
        ...
        Assertions.assertEquals(
                dto.name(),
                employeeCaptor.getValue().getName()
        );

        Assertions.assertEquals(
                dto.employeeRole(),
                employeeCaptor.getValue().getEmployeeRole()
        );

        Assertions.assertEquals(
                dto.username(),
                employeeCaptor.getValue().getUser().getUsername()
        );

        Assertions.assertEquals(
                Role.EMPLOYEE,
                employeeCaptor.getValue().getUser().getRole()
        );

        Assertions.assertEquals(
                "encodedPass",
                employeeCaptor.getValue().getUser().getPassword()
        );
    ...
    @Test
    public void deleteTestForInactiveEmployee() {
