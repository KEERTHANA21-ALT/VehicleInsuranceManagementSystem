...
public class PaymentServiceTest {
    ...
    public void addTest() {
        ...
        when(proposalRepository.findByPolicyHolderUserUsername("john@gmail.com")).thenReturn(Optional.of(proposal1));

        PaymentRequestDto dto = new PaymentRequestDto(
                PaymentMethod.UPI
        );

        paymentService.add("john@gmail.com", dto);
    ...
    public void getByIdPresent() {
        ...
        Assertions.assertEquals(
                PaymentMethod.UPI,
                paymentService.getById("john@gmail.com").paymentMethod()
        );
    ...
    public void getByIdAbsent() {
        ...
        Assertions.assertEquals(
                ...
                Assertions.assertThrows(
                        ...
                        () -> paymentService.getById("john@gmail.com")
                ).getMessage()
        );
    ...
    public void getByProposalIdTest() {
        ...
        Assertions.assertEquals(
                2,
                paymentService.getByProposalId(1L).size()
        );
    ...
    public void updateInvalidId() {
        ...
        Assertions.assertEquals(
                ...
                Assertions.assertThrows(
                        ResourceNotFoundException.class,
                        () -> paymentService.update(10L, PaymentStatus.SUCCESS)
                ).getMessage()
        );
